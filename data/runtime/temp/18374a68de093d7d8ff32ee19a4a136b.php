<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:35:"themes/admin/admin/index/index.html";i:1542353779;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <meta charset="utf-8">
    <title>Get2b <?php echo lang('ADMIN_CENTER'); ?></title>
    ...
    <link rel="stylesheet" href="/themes/admin/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/simplebootadminindex.min.css">
    <!--[if lt IE 9]>
...
<div class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a href="<?php echo url('admin/index/index'); ?>" class="navbar-brand" style="min-width: 200px;text-align: center;">get2b</a>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            ...
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="/themes/admin/public/assets/images/logo-18.png" alt="<?php echo (isset($admin['user_login']) && ($admin['user_login'] !== '')?$admin['user_login']:''); ?>">
                        <?php endif; ?>
...
<script src="/themes/admin/public/assets/simpleboot3/js/adminindex.js"></script>
<script>
    $(function () {
